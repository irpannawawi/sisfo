...
<div class="modal modal-success fade" id="ubah<?php echo $row_anak['id']; ?>">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/act_edit_anak.php" enctype="multipart/form-data" onsubmit="return validasi();">
        ...
        <!-- /.modal -->
                                            ...
                                            <a href="<?=BASE_URL?>/pegawai/data_kepegawaian/delete_anak.php?id=<?=$row_anak['id'];?>&nip=<?=$pegawai->nip?>" class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-placement="top" title="Delete" onClick="return confirm('Yakin hapus data anak <?php echo $row_anak['nama'];?> ?')"> <i class="fa fa-trash"></i> </a>
                                            </center>
...
<div class="modal modal-primary fade" id="modal-danger">
        ...
        <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/act_insert_anak.php" enctype="multipart/form-data" onsubmit="return validasi();">
        <br>
        <table width="100%">
            <tr>
                <td style="padding-left: 20px;">
