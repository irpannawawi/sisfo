                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <?php } else {?>
                                            ...
                                            <a target="__blank" href="<?=BASE_URL?>/assets/berkas/<?=$row_berkas['foto']?>"><?=$row_berkas['foto']?></a>
                                        <?php } ?>
                                        </td>
                                        <td><center>
...
<div class="modal modal-success fade" id="ubah<?php echo $row_berkas['id']; ?>">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/act_edit_berkas.php" enctype="multipart/form-data" onsubmit="return validasi();">
        ...
        <!-- /.modal -->
                                            ...
                                            <a href="<?=BASE_URL?>/pegawai/data_kepegawaian/delete_berkas.php?id=<?=$row_berkas['id']?>&nip=<?=$pegawai->nip?>" class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-placement="top" title="Delete" onClick="return confirm('Yakin hapus?')"> <i class="fa fa-trash"></i> </a>
                                            </center>
...
<div class="modal modal-primary fade" id="modal-danger">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/act_insert_berkas.php" enctype="multipart/form-data" >
                  <table width="100%" class="modal-body">
                  <tr>
                  <td></td>
                  <td>
