              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/act_edit_keluarga.php" enctype="multipart/form-data" onsubmit="return validasi();">
                      <table width="100%" class="modal-body">
                        <tr>
                          ...
                          <td>
                            <div class="modal-body">
                              <input type="hidden" name="nip" value="<?php echo $row_keluarga['nip'];?>"></input>
...
<div class="modal modal-primary fade" id="modal-add">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form role="form" method="POST" name="kategori" action="<?=BASE_URL?>/pegawai/data_kepegawaian/add_keluarga.php" enctype="multipart/form-data" onsubmit="return validasi();">
                  <table width="100%" class="modal-body">
                  <tr>
                  <td>
                    <div class="modal-body">
  ...
  function deleteKeluarga(id)
  {
    Swal.fire({
      ...
      if(result.isConfirmed){
        url = '<?=BASE_URL?>/pegawai/data_kepegawaian/delete.php';
