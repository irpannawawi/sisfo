...
$peg          = $pegawaiObj->getByNip($_POST['nip']);
$peg2          = $pegawaiObj->getByNip($nip);
...
<table width="100%" border="1" style="font-size: 11px;" cellspacing="0" >
  ...
  <tr>
    ...
    <?php 
    $dt_keluarga = $keluargaObj->getKeluarga($row_data['nip']);
    $dt_anak     = $keluargaObj->getAnak($row_data['nip']);
