...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0"><i class="fa fa-user-graduate"></i> Data Pelatihan</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-3" style="margin:0px auto;">
							<?php if(!empty($pelatihan->nama_pelatihan)){?>
								<p>Anda Sedang mengikuti pelatihan <b><?=$pelatihan->nama_pelatihan?></b></p>
							<?php }else{ ?>
								<p>Anda sedang tidak dalam pelatihan apapun</p>
							<?php } ?>
						</div>
					</div>
				</div>
