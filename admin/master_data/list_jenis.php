          ...
          <div class="card col">
            ...
            <div class="card-body">
              ...
              <table class="table table-striped table-bordered" id="table">
                ...
                <tbody>
                  <?php $n=0; while($row = $dataJenis->fetch_assoc()){$n++; ?>
                  <tr>
                    <td><?=$n?></td>
                    <td><?=$row['nama']?></td>
                    <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?=BASE_URL?>/admin/master_data/act_edit_jenis.php" method="POST">
      <div class="modal-body">
          <input type="text" value="" id="editFormJabatan" name="jenis" class="form-control">
