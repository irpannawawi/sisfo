  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="card col">
            <div class="card-header"><h5 class="float-left">Data Status Kepegawaian</h5> <button class="float-right btn btn-success" data-toggle="modal" data-target="#modal-add-pangkat"><i class="fa fa-plus"></i> Tambah data</button></div>
            <div class="card-body">
              <!-- get list data pangkat / golongan -->
                <?php 
                use Lib\Database\Master;
                $statusObj = new Master;
                $dataStatus = $statusObj->getStatus();
                ?>
              <!-- get list data pangkat / golongan -->
              <table class="table table-striped table-bordered" id="table">
                ...
                <tbody>
                  <?php $n=0; while($row = $dataStatus->fetch_assoc()){$n++; ?>
                  <tr>
                    <td><?=$n?></td>
                    <td><?=$row['nama']?></td>
                    <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?=BASE_URL?>/admin/master_data/act_edit_status.php" method="POST">
      <div class="modal-body">
          <input type="text" value="" id="editFormPangkat" name="status" class="form-control">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?=BASE_URL?>/admin/master_data/act_add_status_kepegawaian.php" method="POST">
      <div class="modal-body">
...
function deleteData(id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = '<?=BASE_URL?>/admin/master_data/delete_status_kepegawaian.php?id='+id
