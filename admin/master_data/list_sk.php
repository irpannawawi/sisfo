  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="card col">
            <div class="card-header"><h5 class="float-left">Data SK</h5> <button class="float-right btn btn-success" data-toggle="modal" data-target="#modal-add-pangkat"><i class="fa fa-plus"></i> Tambah data</button></div>
            <div class="card-body">
              ...
              <table class="table table-striped table-bordered" id="table">
                ...
                <tbody>
                  <?php $n=0; while($row = $dataSk->fetch_assoc()){$n++; ?>
                  <tr>
                    <td><?=$n?></td>
                    <td><?=$row['keterangan']?></td>
                    <td>
                      <div class="btn-group">
                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#editModal" onClick="fill_edit_form('<?=$row['id']?>','<?=$row['keterangan']?>')"><i class="fa fa-edit"></i></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?=BASE_URL?>/admin/master_data/act_edit_sk.php" method="POST">
      <div class="modal-body">
          <input type="text" value="" id="editFormJabatan" name="keterangan" class="form-control">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?=BASE_URL?>/admin/master_data/act_add_sk.php" method="POST">
      <div class="modal-body">
...
function deleteData(id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = '<?=BASE_URL?>/admin/master_data/delete_sk.php?id='+id
