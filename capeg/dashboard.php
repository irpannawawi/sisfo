<?php include '../lib/autoload.php'; session_start(); ?>
        ...
        <div class="card">
        	...
        	<div class="card-body">
        		...
        		<div class="row">
        			...
        			<div class="col-12">
                <form method="POST" action="<?=BASE_URL?>/capeg/update_profile.php" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=BASE_URL?>/capeg/update_password.php" method="post">
